      ...
      <nav class="navbar-me navbar navbar-default" id="mainNav">
        <div class="container">
          ...
          <a class="navbar-brand pull-left" href="<?php echo base_url() ?>" title="Undangan Online | Unik, Murah, Modern">
            <img class="img-responsive" src="<?php echo base_url() ?>/assets/base/img/logo.png" alt="Undangan Online | Unik, Murah, Modern">
          </a>          
          <div class="collapse navbar-collapse navbar-ex1-collapse nav-right">
            <ul class="nav navbar-nav main-navbar-nav">
              ...
              <li>
                <a class="nav-link js-scroll-trigger" href="<?= base_url('about-us') ?>">About Us
                </a>
              </li>
              <li>
              ...
              <div class="footer_content">
                <ul class="address">
                  ...
                  <li>
                    ...
                    <span>
                      <a href="mailto:<?= $setting[0]->email ?>">Email: customer@example.com
                        <!-- <?= $setting[0]->email ?> -->
                      </a>
                    </span>
                  </li>
