...
class Beranda extends Controller
{
	...
	public function aboutUs()
    {
        ...
        // Ambil data setting agar footer dan header tetap berfungsi
        $data['setting'] = $this->BerandaModel->get_setting();
        
        // Atur judul halaman
        $data['title'] = 'About Us';
        
        // Tentukan file view mana yang akan dimuat sebagai konten
        $data['view'] = 'base/beranda/v_about_us'; // Nama file view untuk halaman about us
        
        // Muat view layout utama dan kirim semua data yang sudah disiapkan
        return view('base/beranda/layout', $data);
    }
