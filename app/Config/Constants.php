...
define('SITE_NAME', 'AkuNikah'); ///NAMA WEBSITE

// =========== production mode ============
// //LINK DOMAIN WITH URL
define('SITE_UTAMA', 'https://home.localhost:8080'); 
define('SITE_UNDANGAN', 'https://u.localhost:8080');
define('SITE_ADMIN', 'https://admin.localhost:8080/');
define('SITE_BUKUTAMU', 'https://bukutamu.localhost:8080');

//DOMAIN ONLY
define('DOMAIN_UTAMA', 'home.localhost:8080');
define('DOMAIN_UTAMA_WWW', 'home.localhost:8080'); //PAKE WWW
define('DOMAIN_UNDANGAN', 'u.localhost:8080');
